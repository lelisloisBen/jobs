...
class Policies extends Component {
    render() {
        return (
            ...
            <h4>### Category: Accounting/Finance</h4>

    <li>Accountant</li>
    <li>Director Of Finance</li>
    <li>Office Manager Bookkeeper</li>
    ...
    <li>Financial Associate</li>
    <li>Tax Accountant</li>
    <li>Billing Specialist</li>
    <li>Financial Reporting Manager</li>
    <li>Tax Manager</li>
    <li>Bookkeeper</li>
    <li>Full Charge Bookkeeper</li>
    <li>Treasury Analyst</li>
    <li>Budget Analyst</li>
    <li>General Ledger Accountant</li>
    <li>VP Director of Finance</li>
    <li>CNA</li>
